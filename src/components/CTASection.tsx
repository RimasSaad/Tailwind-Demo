        ...
        <section className="w-full">
            <div className="flow flow-col w-full max-w-[1440px] h-[448px] bg-white items-center mx-auto ">
                ...
                <div className="w-[1440px] py-[64px] px-[32px] gap-[48px] items-center mx-auto">
                    <div className="flow flow-col w-[1280px] rounded-[32px] py-[64px] px-[32px] gap-[32px] bg-[var(--bg-secondary)] items-center mx-auto">
                            ...
                            <div className="flow flow-col w-[1216px] h-[44px] gap-[48px]">
                                <div className="w-full max-w-[768px] text-center mx-auto">
                                    ...
                                    <div className="flow flow-col w-[768px] h-[44px] gap-[12px]">
                                        <h4 className="font-inter font-semibold text-[36px] leading-[44px] tracking-[-2px] text-center text-[var(--heading-primary)]">
                                            Get started with free trial
                                        </h4>
                                    </div>
                                    {/* Supporting text */}
                                    <p className="font-inter font-normal text-[18px] leading-[28px] text-center text-[var(--body)]">
                        ...
                        <div className="flex flex-row items-center justify-center gap-[24px]">
                            {/* Get Started Button */}
                            <a href="#" className="w-[128px] h-[44px] bg-[var(--bg-button-primary)] text-white font-inter font-semibold text-[16px] leading-[24px] rounded-[8px] px-[20px] py-[10px] flex items-center justify-center">
                                Get started
                            </a>
                            {/* Learn More Button */}
                            <a href="#" className="w-[115px] h-[44px] flex items-center justify-center gap-[8px] text-[var(--button-link)] font-inter font-semibold text-[16px] leading-[24px]">
                                Learn more
